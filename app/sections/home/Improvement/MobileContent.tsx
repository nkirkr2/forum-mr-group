...
type SliderProps = {
    sliderData: ImprovementData;
}


function MobileContent({ sliderData }: SliderProps) {

    const { images1, images2, title, paragraph } = sliderData;
    ...
    return (
        <>
        <div className={styles.improvement__mobile}>
            <Swiper
            className={styles.improvement__mobile_img}
            ...
            >
                ...
                <SwiperSlide 
                className={styles.improvement__mobile_slide}
                key={i}>
                    <Image src={src} alt={`Слайд ${i + 1}`} fill style={{ objectFit: 'cover' }} />
                </SwiperSlide>
                ))}
            </Swiper>
            <div className={styles.improvement__mobile_text}>
                <p className="paragraph">{paragraph}</p>
            </div>
        </div>
        <div className={styles.improvement__mobile_bg}>
            <Image
        ...
        <div className={styles.improvement__mobile_controls}>
        ...
        <Link href='/improvement' className='page-link'>Подробнее</Link>
        </>
