...
function MobileOlder({ olderContent }: MobileOlderProps) {
    ...
    return (
        <>
        <Swiper
        className={styles.older__mobile_img}
        ...
        <div className={styles.older__mobile_controls}>
        ...
        <div className={styles.older__mobile_bg}>
            <Image
        ...
        <Link href='/history' className='page-link'>Подробнее</Link>
        </>
    )
}

export default MobileOlder;