...
function DesktopApartments({apartmentsData}: ApartmentsProps) {


    const { paragraphs, images } = apartmentsData;
    ...
    return (
        <>
            ...
            >
                ...
                <SwiperSlide key={idx}>
                    <Image src={image} alt="Логотип" fill style={{ objectFit: 'cover' }} />
                </SwiperSlide>
                ))}
            </Swiper>
            ...
            <div className={classNames(styles.apartments__controls, 'slider-controls')}>
...
export default DesktopApartments;