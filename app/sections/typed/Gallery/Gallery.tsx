...
// type GalleryProps = {
//     galleryContent: {images: string[], texts: string[]}
// }

// function Gallery({galleryContent}: GalleryProps) {

//     const {images, texts} = galleryContent;
...
//                     </Swiper>
//                     <Swiper
//                     className={styles.gallery__content_text}
...
//                         ))}
//                     </Swiper>
//                     <div className={styles.gallery__content_controls}>
    ...
    <section className={styles.gallery}>
      <div className="container">
        <div className={styles.gallery__content}>
          ...
          >
            {galleryContent.map((item, idx) => (
              <SwiperSlide key={idx} className={styles.gallery__img_slide}>
                <Image src={encodeURI(item.image)} alt="" fill style={{ objectFit: "cover" }} />
              </SwiperSlide>
            ))}
          </Swiper>
          ...
          >
            {galleryContent.map((item, idx) => (
              <SwiperSlide key={idx}>
                {item.text && <p className="paragraph">{item.text}</p>}
              </SwiperSlide>
            ))}
          </Swiper>
